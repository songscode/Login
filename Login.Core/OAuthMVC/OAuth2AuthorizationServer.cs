...
namespace Login.Core.OAuthMVC
{
    public  class OAuth2AuthorizationServer : IAuthorizationServerHost
    {
        ...
        {
            var consumerRow = ClientDB.New().GetByClientIdentifier(clientIdentifier);
            if (consumerRow == null)
            {
        ...
        public bool CanBeAutoApproved(EndUserAuthorizationRequest authorizationRequest)
        {
            ...
            if (authorizationRequest.ResponseType == EndUserAuthorizationResponseType.AuthorizationCode)
            {
                ...
                var requestingClient = ClientDB.New().GetByClientIdentifier(authorizationRequest.ClientIdentifier);
        ...
        private bool IsAuthorizationValid(HashSet<string> requestedScopes, string clientIdentifier, DateTime issuedUtc, string username)
        {
            ...
            var grantedScopeStrings = clientAuthorizations.Select(e => e.Scope);
